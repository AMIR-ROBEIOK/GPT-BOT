...
#شناسه اکانت
bot = Robot_Rubika("ztlibarnonokolqaqncneyirtgpujkkk")
#......
# شناسه ربات اصلی
my_guid_bot = "u0FjAol0f8edd7e65384f33049ac9d77"
#......
#شناسه گروه
target = "g0DXohp09c1d4af31548545b8174458a"
#......
#شناسه کانال
channell = "c0BbVbH030e2f1359b2a6a254d018704"
#......
#شناسه کانال مورد نظر برای تبلیغات
channell_sin_tabl = "c0BbVbH030e2f1359b2a6a254d018704"
#......
# شناسه کانالی که میخواهید ربات برای شما فایل پست کند را وارد کنید
post_files_to_channell = "c0BbVbH030e2f1359b2a6a254d018704"
...
p = Image.open('/storage/emulated/0/arian.jpg')
bot.sendPhoto(target, '/storage/emulated/0/now.png', p.size,caption=  f"اکانت هوشمند با موفقیت در گروه {GAP} فعال شد 😍🕺")
